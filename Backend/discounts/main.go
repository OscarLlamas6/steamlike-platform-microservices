...
func Saludo(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{"data": "Microservicios Descuentos - Steamlike Platform | Grupo 4 :D"})
}
...
func main() {
	...
	{
		discount.POST("/create", authMiddleware.MiddlewareFunc(), controllers.CreateDiscount())
		discount.GET("/single/:idDiscount", authMiddleware.MiddlewareFunc(), controllers.GetDiscount())
		discount.GET("/games", authMiddleware.MiddlewareFunc(), controllers.GetGamesDiscounts())
		discount.GET("/dlc", authMiddleware.MiddlewareFunc(), controllers.GetDLCDiscounts())
		discount.PUT("/update", authMiddleware.MiddlewareFunc(), controllers.UpdateDiscount())
		discount.DELETE("/delete/:idDiscount", authMiddleware.MiddlewareFunc(), controllers.DeleteDiscount())
	}
