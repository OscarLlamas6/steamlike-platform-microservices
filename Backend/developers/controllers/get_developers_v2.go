...
func GetDevelopersListv2() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if err != nil {
			...
			*successFlag = false
			c.JSON(http.StatusNotFound, responses.Developers{Status: http.StatusNotFound, Message: "error", Success: successFlag, Data: make([]map[string]interface{}, 0)})
			return
		}
		...
		*successFlag = true
		defer db.Close()
		c.JSON(http.StatusOK, responses.Developers{Status: http.StatusOK, Message: "success", Success: successFlag, Data: myFullDevelopersList})
