...
func Saludo(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{"data": "Microservicios Wishlist - Steamlike Platform | Grupo 4 :D"})
}
...
func main() {
	...
	{
		wishlist.POST("/create", authMiddleware.MiddlewareFunc(), controllers.CreateWishlist())
		wishlist.GET("/:username", authMiddleware.MiddlewareFunc(), controllers.GetWishlist())
		wishlist.PUT("/update", authMiddleware.MiddlewareFunc(), controllers.UpdateMyGame())
		wishlist.DELETE("/delete/:idMyGame", authMiddleware.MiddlewareFunc(), controllers.DeleteMyGame())
		wishlist.DELETE("/remove/:idMyGame", authMiddleware.MiddlewareFunc(), controllers.RemoveWishGame())
	}
