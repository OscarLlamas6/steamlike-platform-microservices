...
func GetAllDLCs() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		DLCListQuery, err := db.Query("SELECT idDLC, name, idGame, isDeleted, imageURL, description, releaseDate, isGlobal, globalPrice, globalDiscount FROM DLC;")
		if err != nil {
			defer db.Close()
